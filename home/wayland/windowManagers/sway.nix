  ...
  wayland.windowManager.sway = {
    ...
    config = rec {
      ...
      keybindings = {
        ...
        "${defaultConfig.modifier}+Shift+${defaultConfig.right}" =
          "move right";
          ...
          "${defaultConfig.modifier}+Alt+1" =
            "move container to workspace number 1";
            "${defaultConfig.modifier}+Alt+2" =
              "move container to workspace number 2";
              "${defaultConfig.modifier}+Alt+3" =
                "move container to workspace number 3";
                "${defaultConfig.modifier}+Alt+4" =
                  "move container to workspace number 4";
                  "${defaultConfig.modifier}+Alt+5" =
                    "move container to workspace number 5";
                    "${defaultConfig.modifier}+Alt+6" =
                      "move container to workspace number 6";
                      "${defaultConfig.modifier}+Alt+7" =
                        "move container to workspace number 7";
                        "${defaultConfig.modifier}+Alt+8" =
                          "move container to workspace number 8";
                          "${defaultConfig.modifier}+Alt+9" =
                            ...
                            "${defaultConfig.modifier}+Shift+e" =
